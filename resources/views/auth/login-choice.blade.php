...
<body
    class="bg-grid-pattern font-sans text-white min-h-screen lg:h-screen lg:max-h-screen lg:overflow-hidden flex flex-col justify-between selection:bg-mint selection:text-forest">
    ...
    <header class="w-full max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center z-10 shrink-0">
        <a href="{{ url('/') }}" class="flex items-center space-x-3 group">
            <div
                class="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-mint flex items-center justify-center text-forest font-bold text-lg sm:text-xl shadow-lg shadow-mint/20 group-hover:scale-105 transition-transform">
                <i class="fa-solid fa-graduation-cap"></i>
            </div>
            <div>
                <span class="font-extrabold text-lg sm:text-xl tracking-tight text-white block leading-none">TS
                    Group</span>
                <span class="text-[9px] sm:text-[10px] text-mint font-semibold uppercase tracking-widest">Portal
                    Akademik</span>
            </div>
        </a>

        <div
            class="flex items-center space-x-2 glass-badge px-3.5 py-1.5 rounded-full text-xs font-medium text-gray-300">
            ...
            <div
                        ...
                        <label class="cursor-pointer">
                            ...
                            <div
                                ...
                                <span class="font-bold text-xs">
                                    <span
                                        class="role-label-tab-login {{ $defaultTab === 'login' ? 'inline' : 'hidden' }}">Masuk
                                        Dosen</span>
                                    <span
                                        class="role-label-tab-reg {{ $defaultTab === 'register' ? 'inline' : 'hidden' }}">Daftar
                                        Dosen</span>
                                </span>
                            </div>
                        </label>
                ...
                <div id="tab-login" class="tab-content {{ $defaultTab === 'login' ? 'active' : '' }}">
                    <div class="mb-3">
                        ...
                        <p class="text-[11px] text-gray-500 mt-0.5">Masukkan kredensial akun Anda untuk mengakses
                            dashboard.</p>
                    </div>
                    ...
                    <form id="form-register" method="POST"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            ...
                            <div id="container-dosen-instansi"
                                ...
                                <input type="text" placeholder="Telkom University / Mitra"
                                    class="w-full px-2.5 py-1.5 sm:py-2 bg-gray-50 border border-gray-200 rounded-xl text-xs font-medium text-charcoal placeholder-gray-400 focus:bg-white focus:outline-none focus:border-forest focus:ring-2 focus:ring-forest/10 transition">
                            </div>
                        </div>
    ...
    <!-- Footer Simple -->
    <footer
        class="w-full max-w-7xl mx-auto px-4 sm:px-6 py-2 sm:py-3 flex flex-col sm:flex-row justify-between items-center text-[11px] sm:text-xs text-gray-400 gap-1.5 sm:gap-4 shrink-0">
        <div>
